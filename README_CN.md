...
- *[firmware](firmware)*: 固件升级文件
  - 子目录中 [ROH-LiteS001_ModBus-RTU](firmware/ModBus-RTU) 文件为ROH-LiteS001的ModBus-RTU版本。
  - 子目录中 [ROH-LiteS001_SerialCtrl](firmware/SerialCtrl) 文件为ROH-LiteS001的SerialCtrl版本，能处理90Hz+频率的指令。
  - 子目录中  [ROH-LiteS001_ModBus-RTU+SerialCtrl](firmware/ModBus-RTU+SerialCtrl)文件为ROH-LiteS001的双协议混合版本，推荐使用。
  - 子目录中  [ROH-LiteS001_Can](firmware/Can) 文件为ROH-LiteS001的Can协议版本。
...
- *[UserManual](UserManual)*: ROH用户手册
  - [ROH-LiteS001机器人灵巧手-V1.x.x.pdf](UserManual/ROH-LiteS001机器人灵巧手-V1.0.5.pdf): ROH-LiteS001用户手册。
