...
| ROH_RESET_FORCE               |       1016 | W         |                    | 写入非0值时重置力量值(LiteS001不生效)                                                                                            |
...
| ROH_FINGER_FORCE_TARGET0      |       1115 | R/W       | 0                  | 大拇指力量目标值（uint16），单位 mN，开机时恢复为默认值                                                                          |
| ROH_FINGER_FORCE_TARGET1      |       1116 | R/W       | 0                  | 食指力量目标值（uint16），单位 mN，开机时恢复为默认值                                                                            |
| ROH_FINGER_FORCE_TARGET2      |       1117 | R/W       | 0                  | 中指力量目标值（uint16），单位 mN，开机时恢复为默认值                                                                            |
| ROH_FINGER_FORCE_TARGET3      |       1118 | R/W       | 0                  | 无名指力量目标值（uint16），单位 mN，，开机时恢复为默认值                                                                        |
| ROH_FINGER_FORCE_TARGET4      |       1119 | R/W       | 0                  | 小指力量目标值（uint16），单位 mN，开机时恢复为默认值                                                                            |
...
| ROH_FINGER_FORCE0             |       1175 | R         |                    | 大拇指弯曲力量值（uint16），单位 mN                                                                                              |
| ROH_FINGER_FORCE1             |       1176 | R         |                    | 食指指力量值（uint16），单位 mN                                                                                                  |
...
| ROH_FINGER_FORCE5             |       1180 | R         |                    | 大拇指旋转力量值（uint16），单位 mN                                                                                              |
| ROH_FINGER_FORCE6             |       1181 | R         |                    | 保留                                                                                                                             |
| ROH_FINGER_FORCE7             |       1182 | R         |                    | 保留                                                                                                                             |
| ROH_FINGER_FORCE8             |       1183 | R         |                    | 保留                                                                                                                             |
| ROH_FINGER_FORCE9             |       1184 | R         |                    | 保留                                                                                                                             |
| ROH_FINGER_STOP_SPEED0        |       1185 | R/W       | 16                 | 大拇指弯曲电机堵转停机速度（uint16），单位 逻辑位置/s，开机时恢复为默认值                                                        |
| ROH_FINGER_STOP_SPEED1        |       1186 | R/W       | 16                 | 食指电机堵转停机速度（uint16），单位 逻辑位置/s，开机时恢复为默认值                                                              |
| ROH_FINGER_STOP_SPEED2        |       1187 | R/W       | 16                 | 中指电机堵转停机速度（uint16），单位 逻辑位置/s，开机时恢复为默认值                                                              |
| ROH_FINGER_STOP_SPEED3        |       1188 | R/W       | 16                 | 无名指电机堵转停机速度（uint16），单位 逻辑位置/s，开机时恢复为默认值                                                            |
| ROH_FINGER_STOP_SPEED4        |       1189 | R/W       | 16                 | 小拇指电机堵转停机速度（uint16），单位 逻辑位置/s，开机时恢复为默认值                                                            |
| ROH_FINGER_STOP_SPEED5        |       1190 | R/W       | 16                 | 大拇指旋转电机堵转停机速度（uint16），开机时恢复为默认值                                                                         |
